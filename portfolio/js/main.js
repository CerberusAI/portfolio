    ...
    var ssContactForm = function() {
	    ...
	    $('#contactForm').validate({
            ...
            submitHandler: function(form) {
                ...
                let api = "https://snhjfooy5a.execute-api.us-east-2.amazonaws.com/prod"
                let data = {form_data: $(form).serialize()};
                ...
                function post_to_api(pathToResource) {
                    fetch(api, {method: "POST", body: JSON.stringify(data)}) // 1
